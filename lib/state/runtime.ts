...
export interface RuntimeState {
    ...
    claimAutomaticEvaluation(sessionId: string, fingerprint: string): boolean
}
...
export function createRuntimeState(client: any, logger: Logger): RuntimeState {
    ...
    const automaticEvaluations = new Map<string, string>()
    ...
    return {
        ...
        claimAutomaticEvaluation(sessionId, fingerprint) {
            if (automaticEvaluations.get(sessionId) === fingerprint) return false
            automaticEvaluations.set(sessionId, fingerprint)
            return true
        },
    }
}
